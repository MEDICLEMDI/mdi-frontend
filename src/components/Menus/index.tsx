...
export const profileMenus = (t) => {
    return [
        {icon: 'coin', name: t('menus.point'), route: 'Point', header: t('menus.header.point')},
        {icon: 'book', name: t('menus.receipt'), route: 'Receipt', header: t('menus.header.receipt')},
        {icon: 'heart', name: t('menus.subscribe'), route: 'Subscribe', header: t('menus.header.subscribe')},
        {icon: 'notePlus', name: t('menus.chart'), route: 'Chart', header: t('menus.header.chart')},
        {icon: 'hospital', name: t('menus.medicalState'), route: 'MedicalState', header: t('menuss.header.medicalState')},
        {icon: 'faq', name: t('menus.faq'), route: 'FAQ', header: t('menus.header.faq')},
        {icon: 'exchange', name: t('menus.exchange'), route: 'Exchange', header: t('menus.header.exchange')},
        {icon: 'community', name: t('menus.community'), route: 'Community', header: t('menus.header.community')},
        {icon: 'settings', name: t('menus.settings'), route: 'serviceSettings', header: t('menus.header.settings')},
    ]
}